...
<head>
    ...
    <title>ระบบจัดการสถานที่เก็บ </title>
    <?php include('css.php'); 
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-home"></i> Places</a></li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box" style="background-color:#EAEDED">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">ระบบจัดการสถานที่เก็บ</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="home">
                                        <div style="border: 1px solid #FAEBD7;">
                                            <div id="mainPlaces">
                                                <table name="tablePlaces" id="tablePlaces"
                                                    class="table table-bordered table-striped">
                                                    <thead style=" background-color:#D6EAF8;">
                                                        <tr>
                                                            <th width="80%">ชื่อสถานทีเก็บ</th>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form name="frmAddPlaces" id="frmAddPlaces" action="" method="post">
                        <div class="modal-body">

                            <div class="form-group col-md-6">
                            <label for="recipient-name" class="col-form-label">ชื่อ Places </label>
        ...
        <div class="modal fade" id="modelPlacesEdit" tabindex="-1" role="dialog" aria-labelledby="modelEditLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form name="frmEditPlaces" id="frmEditPlaces">
                            <div class="form-group col-md-6">
                                <label for="recipient-name" class="col-form-label">ชื่อ Places </label>
                                <input type="text" class="form-control" name="editplaces" id="editplaces">
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="btnEditPlaces">แก้ไข</button>
                    </div>
                </div>
            </div>
        </div>
