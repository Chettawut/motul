    ...
    <div class="row">
        <div class="col-sm-7">
            <h6>
                ...
                <br>TEL. 066-149-9223 , 082-556-6594 , LINE @KM5AUTO<br>
        ...
        <div class="col-sm-5">
            <div class="panel panel-default">
                <div class="panel-body" style="padding:2px 10px;">
                    ...
                    ?><br>
                    วันที่จัดส่ง : <?php                    
                    echo substr($json_result["deldate"][0],8).'/'.substr($json_result["sodate"][0],5,2).'/'.substr($json_result["deldate"][0],0,4);
                    ?><br><br>
                </div>
            </div>
        </div>
                    ...
                    ?><br><br></td>
                        ...
                        <tr style="font-size:10px;text-align:left;">
                            ...
                            <td colspan="8">
                                ...
                                {
                                    ?>
                                    &nbsp; <b>ชื่อบัญชี นายนพดล มุกดาสนิท ธนาคารกสิกรไทย สาขาสัตหีบ เลขที่บัญชี 023-3-75646-6 </b>, TEL. 066-149-9223 , 082-556-6594 , LINE @KM5AUTO<br>
                                <?php
                                    }
                                    ?>
