<?php
	...
	$sql = "SELECT a.socode,a.sodate,a.deldate,a.paydate,a.payment,a.currency,a.vat,a.remark,a.salecode,c.stcode,c.stname1,a.cuscode,d.cusname,d.idno,d.road,d.subdistrict,d.district,d.province,d.zipcode,d.tel,b.supstatus ";
