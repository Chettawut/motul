...
<head>
    ...
    <title>ประวัติผู้มาสมัครงาน (Register)</title>
    <?php include('css.php'); 
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-id-card-o"></i> Register</a></li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box" style="background-color:#EAEDED">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">ประวัติผู้มาสมัครงาน (Register)</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                        ...
                                        <table name="tableSupplier" id="tableSupplier"
                                            ...
                                            <thead style=" background-color:#D6EAF8;">
                                                <tr>
                                                    ...
                                                    <th width="55%">ชื่อผู้มาสมัคร</th>
                                                    <th width="15%" style="text-align:center">วันที่สมัคร</th>
