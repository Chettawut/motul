<?php
	...
	$sql .= " where (b.supstatus = '03' or b.supstatus = '04') and b.giveaway = 0 ";
	$sql .= " ORDER BY CASE WHEN b.supstatus = '04' THEN 1 WHEN b.supstatus = '03' THEN 2 END  desc,sodate desc,socode desc";
	// $sql .= "ORDER BY socode desc";
