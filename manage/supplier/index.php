...
<head>
    ...
    <title>จัดการผู้ขาย (Supplier)</title>
    <?php include('css.php'); 
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box" style="background-color:#EAEDED">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">จัดการผู้ขาย (Supplier)</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                        ...
                                        <table name="tableSupplier" id="tableSupplier"
                                            ...
                                            <thead style=" background-color:#D6EAF8;">
                                                <tr>
                                                    ...
                                                    <th width="18%" style="text-align:center">ที่อยู่</th>
                                                    <th width="15%" style="text-align:center">สถานะการใช้งาน</th>
