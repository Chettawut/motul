<?php
    ...
    $strSQL .= "supcode='".$_POST["editsupcode"]."',supname='".$_POST["editsupname"]."',idno='".$_POST["editidno"]."',road='".$_POST["editroad"]."' ";
    ...
    // echo $strSQL;
        ...
        if($query) {
            echo json_encode(array('status' => '1','message'=> 'แก้ไขรหัสลูกค้า '.$_POST["editsupcode"].' สำเร็จ'));
        }
        else
        {
