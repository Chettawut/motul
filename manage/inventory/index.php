...
<head>
    ...
    <title>จัดการวัสดุ (Inventory)</title>
    <?php include('css.php'); 
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-cube"></i> Inventory</a></li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box" style="background-color:#EAEDED">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">จัดการวัสดุ (Inventory)</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
        ...
        <div class="modal fade" id="modelStockEdit" tabindex="-1" role="dialog" aria-labelledby="modelEditLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="exampleModalLabel"><i class="fa fa-cube" aria-hidden="true"></i>
                            แก้ไขรหัสสินค้า (Edit Inventory)</h2>
                    </div>
