                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo PATH; ?>/issue/"><i class="fa fa-calendar-check-o"></i> ตัดขาย</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo PATH; ?>/so/"><i class="fa fa-cart-plus"></i> ใบสั่งขาย</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo PATH; ?>/customer/"><i class="fa fa-id-card-o"></i>
                                    ระบบจัดการลูกค้า</a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <!-- <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="/customer/"><i class="fa fa-id-card-o"></i>
                                    ระบบจัดการลูกค้า</a>
                            </li>
                        </ul>
                    </li> -->
