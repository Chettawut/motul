<?php
	...
	$sql .= " where (b.supstatus = '01' or b.supstatus = '02') and b.giveaway = 0 ";
	// $sql .= "ORDER BY sodate desc,socode desc";
	$sql .= " ORDER BY CASE WHEN b.supstatus = '01' THEN 1 WHEN b.supstatus = '02' THEN 2 END ,sodate desc,socode desc";	
