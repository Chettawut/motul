...
<head>
    ...
    <title>อนุมัติขาย (Sales Approve)</title>
    <?php include('css.php'); 
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Account
                    <small>อนุมัติขาย</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-cart-plus"></i>อนุมัติขาย</a></li>
                </ol>
            </section>
            <!-- Main content -->
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box" style="background-color:#EAEDED">
                            <div class="box-header">
                                ...
                                <h3 id="txtHead" class="box-title">อนุมัติขาย (Sales Approve)</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <form action="invoice-print.php" method="post" target="_blank">
                                        <button type="button" id="btnBack" style="display:none;"
                                        ...
                                        <!-- <button type="submit" id="btnPrintInvoice" style="display:none;"
                                            class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i>
                                            Print ใบกำกับภาษี</button>
                                        <button type="submit" id="btnPrintReceipt" formaction="receipt-print.php" style="display:none;"
                                            class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i>
                                            Print ใบเสร็จรับเงิน</button>  
                                        <button type="submit" id="btnPrintInvoice2" style="display:none;"
                                            class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i>
                                            Print ใบกำกับภาษี</button>
                                        <button type="submit" id="btnPrintReceipt2" formaction="receipt-print.php" style="display:none;"
                                            class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i>
                                            Print ใบเสร็จรับเงิน</button>                                       -->
                                        <input type="hidden" id="printsocode" class="btn btn-default" name="printsocode"
                                            value="John">
                                    </form>
                                    <!-- <form action="receipt-print.php" method="post" target="_blank">

                                        <button type="submit" id="btnPrintReceipt" style="display:none;"
                                            class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i>
                                            Print</button>
                                        <input type="hidden" id="printsocode" class="btn btn-default" name="printsocode"
                                            value="John">
                                ...
                                <table name="tableSO" id="tableSO" class="table table-bordered table-striped">
                                    <thead style="background-color:#D6EAF8;">
                                        <tr>
                                            ...
                                            <th>รายงานสินค้า</th>
                                            <th>ลูกค้า</th>
                                            <th style="width:11%;text-align:left;">สถานะ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div id="divfrmEditSO" style="display:none;">
                            <form name="frmEditSO" id="frmEditSO" onkeydown="return event.key != 'Enter';">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="recipient-name" class="col-form-label">สกุลเงิน</label>
                                        <select class="form-control" name="editcurrency" id="editcurrency" disabled>
                                            <option value="บาท" selected>บาท</option>
                                            <option value="ดอลล่า">ดอลล่า</option>
                                            <option value="เยน">เยน</option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <div class="radio">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="editvat" value="N" disabled> ไม่มี
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="comment">หมายเหตุ:</label>
                                        <textarea class="form-control" rows="5" name="editremark" id="editremark"
                                            disabled></textarea>
                                    </div>
